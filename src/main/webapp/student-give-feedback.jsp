...
<title>ClubCraft | Student Feedback</title>
...
.adminToggle:checked ~.adminButtons a {
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="public/assets/images/logo/student-review.png"
						style="width: 400px; height: 290px;">
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<%
						String message = (String) session.getAttribute("feedback");
						if (message != null) {
					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<form role="form" action="AddFeedback" method="post">
								<div class="form-row">
									<div class="form-group col-md-12">
										<label for="studentName">Student Name</label> <input
											...
											name="studentName"
											value="<%=session.getAttribute("sname")%>" value="" readonly>
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-12">
										<label for="collegeName">College Name</label> <input
											...
											name="collegeName"
											value="<%=session.getAttribute("college_name")%>" value=""
											readonly>
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-12">
										<label for="feedback">Fill Feedback</label>
								...
								<div class="form-row">
									<div class="form-group col-md-12">
										<button type="submit" class="btn btn-info" id="buttonValidate"
											style="width: 140px;">Submit Feedback</button>
	...
	<footer class="bg_img"
		...
		<div class="footer-bottom">
			<div class="container">
				<p>&copy;&nbsp;ClubCart - 2024 All Rights Reserved.</p>
			</div>
		</div>
	</footer>
