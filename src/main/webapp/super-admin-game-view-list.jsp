...
<title>ClubCraft | Super Admin View Game List</title>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						...
						<%
							String deleteGame = (String) session.getAttribute("delGame");
							if (deleteGame != null) {
								session.removeAttribute("delGame");
						%>
						<div class="alert alert-danger" id="danger">Game deleted successfully.</div>
						<%
							}
						%>
								...
								<table id="zctb"
									...
									<tbody>
										<tr>
											...
											<td><a href="super-admin-delete-game.jsp?del=<%=resultset.getInt("gid")%>"onclick="return confirm('Do you want to delete');"><i
