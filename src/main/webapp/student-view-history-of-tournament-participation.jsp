...
<title>ClubCraft | Tournament Participation History</title>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="panel panel-info">
						<div class="panel-heading">History of Tournament
							Participation</div>
						<div class="panel-body">
							<table class="table">
								<tr>
									...
									<th>Game Name</th>
									<th>Team Name</th>
									<th>Tournament College Name</th>
									<th>Register Date</th>
								</tr>
								<%
									int count = 0;
									ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblentryregistertournament where student_name='" + session.getAttribute("sname") + "'");
								...
								%>
									...
									<td><%=resultset.getString("tournament_college_name") %></td>
									<td><%=resultset.getString("register_at") %></td>
								<%
									}
								%>
							</table>
