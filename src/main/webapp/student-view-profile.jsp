...
<title>ClubCraft | Student Profile</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="public/assets/icons/update-profile.png">
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-info shadow p-6 mb-8">
						...
						<div class="panel-body">
							<%
								String editInfo = (String) session.getAttribute("message");
								if (editInfo != null) {
									session.removeAttribute("message");
							%>
							<div class="alert alert-info" id="info">Student info
								updated successfully.</div>
							<%
								}
							%>
							<%
								ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblstudent where uname='" + session.getAttribute("uname") + "'");
								if (resultset.next()) {
							%>
							<form action="UpdateStudentAccount" method="post"
								enctype="multipart/form-data">
								<div class="form-row">
									<div class="form-group col-md-4"></div>
									<div class="form-group col-md-4">
										<image src="uploads/<%=resultset.getString("photo")%>"
											style="width:150px;height:120px;"></image>
									</div>
									<div class="form-group col-md-4"></div>
								</div>
								<div class="form-row">
									<%-- <div class="form-group col-md-6">
										<label>Student Id</label> <input class="form-control"
											type="text" name="sid"
											value="<%=resultset.getString("sid")%>" readonly />
									</div> --%>
									<div class="form-group col-md-12">
										<label>Student Full Name</label> <input class="form-control"
											type="text" name="sname" id="sname"
											placeholder="Student Name"
											onkeypress="return lettersValidate(event)"
											value="<%=resultset.getString("sname")%>" readonly/>
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-6">
								...
								<div class="form-row">
									<div class="form-group col-md-12">
										...
										<textarea class="form-control" type="text" name="address"
											placeholder="Address" id="address" value=""><%=resultset.getString("address")%></textarea>
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-6">
									...
									<div class="form-group col-md-6">
										<label>Password</label> <input class="form-control"
											...
											maxlength="12" value="<%=resultset.getString("upass")%>"
											readonly />
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-12">
										<label>College Name</label> <select class="form-control"
											name="collegeName" id="collegeName" readonly>
											<option readonly value="<%=resultset.getString("college_name")%>"><%=resultset.getString("college_name")%></option>
											<%
												ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select college_name from tbladmin");
												while (rs.next()) {
											%>
											<option value="<%=rs.getString("college_name")%>"><%=rs.getString("college_name")%></option>
											<%
												}
											%>
										</select>
								...
								<div class="form-row">
									<div class="form-group col-md-12">
										<label>Select Game</label> <select class="form-control"
											name="gameName" id="gameName">
											<option value="<%=resultset.getString("game_name")%>"><%=resultset.getString("game_name")%></option>
											<%
