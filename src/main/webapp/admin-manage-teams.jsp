...
<title>ClubCraft | Admin View Team List</title>
						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<table id="zctb"
									...
									<%
										int count = 0;
										ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("SELECT * from  tblteam where college_name='"+session.getAttribute("collegeName")+"'");
