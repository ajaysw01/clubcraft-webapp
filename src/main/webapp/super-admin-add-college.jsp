...
<title>ClubCraft | Super Admin Add College</title>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						...
						%>
						<div class='alert alert-success' id='success'>College added
							successfully.</div>
						<%
							}
						%>
						...
						%>
						<div class='alert alert-danger' id='danger'>This college name already added.</div>
						<%
							}
						%>
						<div class="row">
