...
<title>ClubCraft | Tournament Registration</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-12">
					<img src="public/assets/images/logo/tournament-registration.png"
						style="width: 400px; height: 290px;">
				</div>
				<div class="col-md-8 col-sm-8 col-xs-12">
					<h3>For Tournament Registration ! Please contact your college admin.</h3>
				</div>
			</div>
		</div>
	</section>
