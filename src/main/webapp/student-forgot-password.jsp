				...
				<div class="header-wrapper">
					...
					<div class="menu-area">
						<ul class="menu">
							...
							<li><a href="student-login.jsp"><i class="fas fa-user"></i>Student Login</a>
							</li>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-info shadow p-6 mb-8">
						...
						<div class="panel-body">
							...
							%>
							<div class="alert alert-success" id="success">Your password send successfully in your email.</div>
							<%
								}
							%>
							<%
								String forgot = (String) session.getAttribute("forgot-password");
								if (forgot != null) {
									session.removeAttribute("forgot-password");
							%>
							<div class="alert alert-danger" id="danger">Invalid email id, please enter your correct email id</div>
							<%
								}
							%>
							<form action="StudentForgetPassword" method="post">
								<div class="form-group">
									<label>Your Register Email Id</label> <input class="form-control"
										type="text" name="email" placeholder="Your Register Email Id" required/>
								</div>
								
								<div class="form-group">
									<button type="submit" class="btn btn-info"
										style="width: 150px;">Get Password</button>
								</div>
							</form>
						</div>
					</div>
