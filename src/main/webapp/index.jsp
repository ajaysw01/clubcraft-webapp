...
<body>
	...
	<div class="banner-text">
		<div class="container">
			<br> <br> <br>
			<form action="search-tournament.jsp" method="post">
				<div class="row">
					<div class="col-md-3 col-sm-3 col-xs-12"></div>
					<div class="col-md-6 col-sm-6 col-xs-12">
						<select name="gameType" class="form-control"
							placeholder="Search Tournament" style="height: 60px;">
					...
					<div class="col-md-2 col-sm-2 col-xs-12">
						<button class="btn btn-warning" style="height: 60px;">Search
							Tournament</button>
					</div>
				</div>
			</form>
		...
		<div class="container">
			...
			<div class="col-md-12">
				<div class="row">
					...
					ResultSet retriveCurrentTournament = DatabaseConnection
							.getResultFromSqlQuery("select * from tbltournament  where end_date >='" + modifiedDate + "' and  start_date<='"
							+ modifiedDate + "' limit 24");
	...
	<div class="news-section" id="blogs">
		<div class="container">
			...
			<div class="row">
				...
				ResultSet retriveTournament = DatabaseConnection
						.getResultFromSqlQuery("select * from tbltournament  where start_date >'" + modifiedDate + "' limit 24");
