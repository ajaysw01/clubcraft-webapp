...
/**
 * Servlet implementation class UpdateSuperAdminDetails
 */
@WebServlet("/UpdateSuperAdminDetails")
public class UpdateSuperAdminDetails extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (i > 0) {
				...
				response.sendRedirect("super-admin-profile.jsp");
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
